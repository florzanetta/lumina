...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SessionQuote'
        db.create_table(u'lumina_sessionquote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('studio', self.gf('django.db.models.fields.related.ForeignKey')(related_name='session_quotes', to=orm['lumina.Studio'])),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='session_quotes', to=orm['lumina.Customer'])),
            ...
            ('accepted_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lumina.LuminaUser'])),
            ('accepted_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'lumina', ['SessionQuote'])


    def backwards(self, orm):
        # Deleting model 'SessionQuote'
        db.delete_table(u'lumina_sessionquote')
    ...
    models = {
        ...
        u'lumina.sessionquote': {
            ...
            'accepted_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['lumina.LuminaUser']"}),
