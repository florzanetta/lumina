...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LuminaUser.studio'
        db.add_column(u'lumina_luminauser', 'studio',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='photographers', to=orm['lumina.Studio']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LuminaUser.studio'
        db.delete_column(u'lumina_luminauser', 'studio_id')
