...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LuminaUser.customer_of'
        db.alter_column(u'lumina_luminauser', 'customer_of_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lumina.Studio']))

    def backwards(self, orm):

        # Changing field 'LuminaUser.customer_of'
        db.alter_column(u'lumina_luminauser', 'customer_of_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lumina.LuminaUser']))
