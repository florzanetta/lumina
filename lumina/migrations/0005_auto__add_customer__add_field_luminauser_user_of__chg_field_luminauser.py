...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'lumina_customer', (
            ...
            ('customer_of', self.gf('django.db.models.fields.related.ForeignKey')(related_name='customers', to=orm['lumina.Studio'])),
        ))
        ...
        # Changing field 'LuminaUser.studio'
        db.alter_column(u'lumina_luminauser', 'studio_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lumina.Studio']))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'LuminaUser.studio'
        raise RuntimeError("Cannot reverse this migration. 'LuminaUser.studio' and its values cannot be restored.")
