...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SessionQuoteAlternative'
        db.create_table(u'lumina_sessionquotealternative', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session_quote', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quote_alternatives', to=orm['lumina.SessionQuote'])),
        ...
        db.send_create_signal(u'lumina', ['SessionQuoteAlternative'])

        # Adding field 'SessionQuote.accepted_quote_alternative'
        db.add_column(u'lumina_sessionquote', 'accepted_quote_alternative',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lumina.SessionQuoteAlternative']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SessionQuoteAlternative'
        db.delete_table(u'lumina_sessionquotealternative')

        # Deleting field 'SessionQuote.accepted_quote_alternative'
        db.delete_column(u'lumina_sessionquote', 'accepted_quote_alternative_id')
    ...
    models = {
        ...
        u'lumina.sessionquotealternative': {
            'Meta': {'object_name': 'SessionQuoteAlternative'},
            'cost': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_quantity': ('django.db.models.fields.PositiveIntegerField', [], {}),
