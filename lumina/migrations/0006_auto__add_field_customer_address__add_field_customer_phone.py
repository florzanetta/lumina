...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'lumina_customer', 'address')

        # Deleting field 'Customer.phone'
        db.delete_column(u'lumina_customer', 'phone')
