...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SessionQuoteAlternative', fields ['image_quantity', 'session_quote', 'cost']
        db.delete_unique(u'lumina_sessionquotealternative', ['image_quantity', 'session_quote_id', 'cost'])

        # Adding unique constraint on 'SessionQuoteAlternative', fields ['image_quantity', 'session_quote']
        db.create_unique(u'lumina_sessionquotealternative', ['image_quantity', 'session_quote_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SessionQuoteAlternative', fields ['image_quantity', 'session_quote']
        db.delete_unique(u'lumina_sessionquotealternative', ['image_quantity', 'session_quote_id'])

        # Adding unique constraint on 'SessionQuoteAlternative', fields ['image_quantity', 'session_quote', 'cost']
        db.create_unique(u'lumina_sessionquotealternative', ['image_quantity', 'session_quote_id', 'cost'])
    ...
    models = {
        ...
        u'lumina.sessionquote': {
            ...
            'accepted_quote_alternative': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['lumina.SessionQuoteAlternative']"}),
        ...
        u'lumina.sessionquotealternative': {
            'Meta': {'unique_together': "(('session_quote', 'image_quantity'),)", 'object_name': 'SessionQuoteAlternative'},
            'cost': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_quantity': ('django.db.models.fields.PositiveIntegerField', [], {}),
