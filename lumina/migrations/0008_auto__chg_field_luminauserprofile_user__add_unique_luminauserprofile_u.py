...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LuminaUserProfile.user'
        db.alter_column(u'lumina_luminauserprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'LuminaUserProfile', fields ['user']
        db.create_unique(u'lumina_luminauserprofile', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LuminaUserProfile', fields ['user']
        db.delete_unique(u'lumina_luminauserprofile', ['user_id'])


        # Changing field 'LuminaUserProfile.user'
        db.alter_column(u'lumina_luminauserprofile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
