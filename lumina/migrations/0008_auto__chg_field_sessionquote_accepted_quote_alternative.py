...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SessionQuote.accepted_quote_alternative'
        db.alter_column(u'lumina_sessionquote', 'accepted_quote_alternative_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['lumina.SessionQuoteAlternative']))

    def backwards(self, orm):

        # Changing field 'SessionQuote.accepted_quote_alternative'
        db.alter_column(u'lumina_sessionquote', 'accepted_quote_alternative_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lumina.SessionQuoteAlternative']))
