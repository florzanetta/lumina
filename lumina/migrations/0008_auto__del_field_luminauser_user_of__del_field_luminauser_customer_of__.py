...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LuminaUser.user_of'
        db.delete_column(u'lumina_luminauser', 'user_of_id')

        # Deleting field 'LuminaUser.customer_of'
        db.delete_column(u'lumina_luminauser', 'customer_of_id')

        # Adding field 'LuminaUser.user_for_studio'
        db.add_column(u'lumina_luminauser', 'user_for_studio',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='users', null=True, to=orm['lumina.Studio']),
                      keep_default=False)

        # Adding field 'LuminaUser.user_for_customer'
        db.add_column(u'lumina_luminauser', 'user_for_customer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='users', null=True, to=orm['lumina.Customer']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LuminaUser.user_of'
        db.add_column(u'lumina_luminauser', 'user_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='users', null=True, to=orm['lumina.Customer'], blank=True),
                      keep_default=False)

        # Adding field 'LuminaUser.customer_of'
        db.add_column(u'lumina_luminauser', 'customer_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='users', null=True, to=orm['lumina.Studio'], blank=True),
                      keep_default=False)

        # Deleting field 'LuminaUser.user_for_studio'
        db.delete_column(u'lumina_luminauser', 'user_for_studio_id')

        # Deleting field 'LuminaUser.user_for_customer'
        db.delete_column(u'lumina_luminauser', 'user_for_customer_id')
