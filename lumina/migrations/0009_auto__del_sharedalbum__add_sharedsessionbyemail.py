...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'lumina_sharedalbum', (
            ('album', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shares_via_email', to=orm['lumina.Session'])),
            ('random_hash', self.gf('django.db.models.fields.CharField')(max_length=36, unique=True)),
            ('shared_with', self.gf('django.db.models.fields.EmailField')(max_length=254)),
