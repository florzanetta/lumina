...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'lumina_session', 'user_id')

        # Adding field 'Session.studio'
        db.add_column(u'lumina_session', 'studio',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Session.user'
        raise RuntimeError("Cannot reverse this migration. 'Session.user' and its values cannot be restored.")
        # Deleting field 'Session.studio'
        db.delete_column(u'lumina_session', 'studio_id')
