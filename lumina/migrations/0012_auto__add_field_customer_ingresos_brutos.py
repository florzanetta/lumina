...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.ingresos_brutos'
        db.add_column(u'lumina_customer', 'ingresos_brutos',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.ingresos_brutos'
        db.delete_column(u'lumina_customer', 'ingresos_brutos')
