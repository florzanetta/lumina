...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LuminaUser.phone'
        db.add_column(u'lumina_luminauser', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LuminaUser.cellphone'
        db.add_column(u'lumina_luminauser', 'cellphone',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LuminaUser.alternative_email'
        db.add_column(u'lumina_luminauser', 'alternative_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LuminaUser.notes'
        db.add_column(u'lumina_luminauser', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LuminaUser.phone'
        db.delete_column(u'lumina_luminauser', 'phone')

        # Deleting field 'LuminaUser.cellphone'
        db.delete_column(u'lumina_luminauser', 'cellphone')

        # Deleting field 'LuminaUser.alternative_email'
        db.delete_column(u'lumina_luminauser', 'alternative_email')

        # Deleting field 'LuminaUser.notes'
        db.delete_column(u'lumina_luminauser', 'notes')
