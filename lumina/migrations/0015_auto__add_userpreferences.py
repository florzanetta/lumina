...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'lumina_userpreferences', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('send_emails', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='preferences', unique=True, null=True, to=orm['lumina.LuminaUser'])),
        ))
        db.send_create_signal(u'lumina', ['UserPreferences'])


    def backwards(self, orm):
        # Deleting model 'UserPreferences'
        db.delete_table(u'lumina_userpreferences')
    ...
    models = {
        ...
        u'lumina.userpreferences': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'preferences'", 'unique': 'True', 'null': 'True', 'to': u"orm['lumina.LuminaUser']"})
        }
    }
