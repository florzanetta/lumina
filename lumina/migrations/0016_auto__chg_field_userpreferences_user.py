...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserPreferences.user'
        db.alter_column(u'lumina_userpreferences', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, unique=True, to=orm['lumina.LuminaUser']))

    def backwards(self, orm):

        # Changing field 'UserPreferences.user'
        db.alter_column(u'lumina_userpreferences', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['lumina.LuminaUser']))
