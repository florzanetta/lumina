...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'lumina_customertype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('studio', self.gf('django.db.models.fields.related.ForeignKey')(related_name='customer_types', to=orm['lumina.Studio'])),
        ))
        db.send_create_signal(u'lumina', ['CustomerType'])

        # Adding model 'SessionType'
        db.create_table(u'lumina_sessiontype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('studio', self.gf('django.db.models.fields.related.ForeignKey')(related_name='session_types', to=orm['lumina.Studio'])),
        ))
        db.send_create_signal(u'lumina', ['SessionType'])

        # Adding field 'Session.session_type'
        db.add_column(u'lumina_session', 'session_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['lumina.SessionType']),
                      keep_default=False)

        # Adding field 'Customer.customer_type'
        db.add_column(u'lumina_customer', 'customer_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['lumina.CustomerType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CustomerType'
        db.delete_table(u'lumina_customertype')

        # Deleting model 'SessionType'
        db.delete_table(u'lumina_sessiontype')

        # Deleting field 'Session.session_type'
        db.delete_column(u'lumina_session', 'session_type_id')

        # Deleting field 'Customer.customer_type'
        db.delete_column(u'lumina_customer', 'customer_type_id')
