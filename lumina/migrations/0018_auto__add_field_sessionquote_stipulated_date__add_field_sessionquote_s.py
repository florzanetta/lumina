...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionQuote.stipulated_date'
        db.add_column(u'lumina_sessionquote', 'stipulated_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 5, 0, 0)),
                      keep_default=False)

        # Adding field 'SessionQuote.stipulated_down_payment'
        db.add_column(u'lumina_sessionquote', 'stipulated_down_payment',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionQuote.stipulated_date'
        db.delete_column(u'lumina_sessionquote', 'stipulated_date')

        # Deleting field 'SessionQuote.stipulated_down_payment'
        db.delete_column(u'lumina_sessionquote', 'stipulated_down_payment')
