...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PreviewSize'
        db.create_table(u'lumina_previewsize', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('max_size', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('studio', self.gf('django.db.models.fields.related.ForeignKey')(related_name='preview_sizes', to=orm['lumina.Studio'])),
        ))
        db.send_create_signal(u'lumina', ['PreviewSize'])

        # Adding unique constraint on 'PreviewSize', fields ['max_size', 'studio']
        db.create_unique(u'lumina_previewsize', ['max_size', 'studio_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PreviewSize', fields ['max_size', 'studio']
        db.delete_unique(u'lumina_previewsize', ['max_size', 'studio_id'])

        # Deleting model 'PreviewSize'
        db.delete_table(u'lumina_previewsize')
