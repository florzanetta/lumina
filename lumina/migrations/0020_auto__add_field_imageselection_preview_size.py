...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageSelection.preview_size'
        db.add_column(u'lumina_imageselection', 'preview_size',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lumina.PreviewSize'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImageSelection.preview_size'
        db.delete_column(u'lumina_imageselection', 'preview_size_id')
