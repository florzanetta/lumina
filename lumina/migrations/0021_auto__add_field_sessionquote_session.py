...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionQuote.session'
        db.add_column(u'lumina_sessionquote', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='quotes', null=True, to=orm['lumina.Session']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionQuote.session'
        db.delete_column(u'lumina_sessionquote', 'session_id')
