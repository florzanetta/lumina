...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageSelection.quote'
        db.add_column(u'lumina_imageselection', 'quote',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lumina.SessionQuote'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImageSelection.quote'
        db.delete_column(u'lumina_imageselection', 'quote_id')
