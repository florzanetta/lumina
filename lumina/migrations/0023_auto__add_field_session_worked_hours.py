...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.worked_hours'
        db.add_column(u'lumina_session', 'worked_hours',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.worked_hours'
        db.delete_column(u'lumina_session', 'worked_hours')
