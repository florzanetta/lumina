...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionQuote.give_full_quality_images'
        db.add_column(u'lumina_sessionquote', 'give_full_quality_images',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionQuote.give_full_quality_images'
        db.delete_column(u'lumina_sessionquote', 'give_full_quality_images')
