...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionQuote.currency'
        db.add_column(u'lumina_sessionquote', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='ARS', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionQuote.currency'
        db.delete_column(u'lumina_sessionquote', 'currency')
