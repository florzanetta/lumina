...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'lumina_session', 'created',
        ...
        db.add_column(u'lumina_session', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 21, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'SessionQuote.created'
        db.add_column(u'lumina_sessionquote', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 21, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'SessionQuote.last_modified'
        db.add_column(u'lumina_sessionquote', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 21, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Image.created'
        db.add_column(u'lumina_image', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 21, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Image.last_modified'
        db.add_column(u'lumina_image', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 21, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ImageSelection.created'
        db.add_column(u'lumina_imageselection', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 21, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ImageSelection.last_modified'
        db.add_column(u'lumina_imageselection', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 21, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'SessionQuoteAlternative.created'
        db.add_column(u'lumina_sessionquotealternative', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 21, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'lumina_session', 'created')

        # Deleting field 'Session.last_modified'
        db.delete_column(u'lumina_session', 'last_modified')

        # Deleting field 'SessionQuote.created'
        db.delete_column(u'lumina_sessionquote', 'created')

        # Deleting field 'SessionQuote.last_modified'
        db.delete_column(u'lumina_sessionquote', 'last_modified')

        # Deleting field 'Image.created'
        db.delete_column(u'lumina_image', 'created')

        # Deleting field 'Image.last_modified'
        db.delete_column(u'lumina_image', 'last_modified')

        # Deleting field 'ImageSelection.created'
        db.delete_column(u'lumina_imageselection', 'created')

        # Deleting field 'ImageSelection.last_modified'
        db.delete_column(u'lumina_imageselection', 'last_modified')

        # Deleting field 'SessionQuoteAlternative.created'
        db.delete_column(u'lumina_sessionquotealternative', 'created')
