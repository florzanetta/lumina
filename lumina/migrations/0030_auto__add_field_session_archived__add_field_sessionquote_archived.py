...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.archived'
        db.add_column(u'lumina_session', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SessionQuote.archived'
        db.add_column(u'lumina_sessionquote', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.archived'
        db.delete_column(u'lumina_session', 'archived')

        # Deleting field 'SessionQuote.archived'
        db.delete_column(u'lumina_sessionquote', 'archived')
