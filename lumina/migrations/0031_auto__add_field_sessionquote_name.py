...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionQuote.name'
        db.add_column(u'lumina_sessionquote', 'name',
                      self.gf('django.db.models.fields.CharField')(default='(no name)', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionQuote.name'
        db.delete_column(u'lumina_sessionquote', 'name')
