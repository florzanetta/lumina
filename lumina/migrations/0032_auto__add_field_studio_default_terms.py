...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Studio.default_terms'
        db.add_column(u'lumina_studio', 'default_terms',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Studio.default_terms'
        db.delete_column(u'lumina_studio', 'default_terms')
    ...
    models = {
        ...
        u'lumina.studio': {
            ...
            'default_terms': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
